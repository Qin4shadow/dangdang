		...
		<form action="${path }/book/insert" method="post" enctype="multipart/form-data">
			<table>
				<tr>
					...
					<td>页数：</td>
					<td><input type="number" name="book.pagination" class="el-input__inner"></td>
				</tr>
				<tr>
					<td>所属分类：</td>
					<td>
					...
					<td>字数：</td>
					<td><input type="number" name="book.printCount" class="el-input__inner"></td>
				</tr>
				...
				<tr>
					...
					<td rowspan="3">
						<label id="file_upload1_label" for="file_upload1">
							...
							<img id="uploadimg" src="${path }/back/photo/${book.src}" alt="" width="118px" height="143px" />
						</label> 
				...
				<tr>
					...
					<td>编辑推荐：</td>
					<td rowspan="2"><textarea class="el-textarea__inner" name="book.recom"></textarea></td>
				</tr>
				<tr>
					<td>出版社：</td>
				...
				<tr>
					...
					<td>内容简介：</td>
					<td rowspan="2"><textarea class="el-textarea__inner" name="book.brief"></textarea></td>
				</tr>
				<tr>
					<td>版次：</td>
				...
				<tr>
					...
					<td>作者简介：</td>
					<td rowspan="2"><textarea class="el-textarea__inner" name="book.aboutAuthor"></textarea></td>
				</tr>
				<tr>
					<td>印次：</td>
				...
				<tr>
					...
					<td>媒体评论：</td>
					<td rowspan="2"><textarea class="el-textarea__inner" name="book.media"></textarea></td>
				</tr>
				<tr>
					<td>包装：</td>
					<td><input type="text" name="book.packaging" class="el-input__inner"></td>
					<td></td>
				</tr>
			</table>
