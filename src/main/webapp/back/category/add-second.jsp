...
<html>
  ...
  <body style="background-color: #f0f9fd;">
  	...
  	<form action="${path }/cate/insertCate" method="post">
		所属一级类别:		
		<select name="category.parentId" class="el-select__inner">
			<c:forEach items="${checkFirst }" var="li">
			<option value="${li.id }">${li.cateName }</option>
			</c:forEach>
		</select>
  		<br/><br/>
  		二级类别名:<input class="el-input__inner" type="text" name="category.cateName" id="sname"/><br/><br/>
