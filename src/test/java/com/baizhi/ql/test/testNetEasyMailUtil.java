 ...
 *      password  为发送用户的登录密码
 */
public class testNetEasyMailUtil {
 
	//发送邮箱的邮箱名
	public static String username = "15236674712@163.com";
	//发送邮箱的授权码
	private static String password = "aaa15236674712";
	...
	public static void getEmail(String email,String code){
	...
	public static void main(String[] args) {
		...
		//接收邮件的邮箱  任何邮箱都可以
		getEmail("897641394@qq.com",code);
	}
